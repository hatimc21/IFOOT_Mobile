...
const Reservation_user = ({ navigation, route }) => {
            ...
            <View style={styles.container}>
                <View>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate(("Myaddedreservations"),userid)}
                    >
                        <Text style={styles.textb}>my added reservations</Text>
                    </TouchableOpacity>
                    </View>
                </View>
                <FlatList
                ...
                <View style={styles.NavContainer}>
                    <View style={styles.NavBar}>
                        ...
                        <Pressable onPress={() => navigation.navigate(("Nearby"),userid)}
                            style={styles.IconBeahve}
                            android_ripple={{ borderless: true, radius: 50 }}>
